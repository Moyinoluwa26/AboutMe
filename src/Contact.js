...
const Contact = () => {
    return ( <div id='Contact' name="Contact" className='overscroll-none mx-0  h-full bg-black p-10 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg lg mx-auto h-full'>
            <div className='pb-8'>
