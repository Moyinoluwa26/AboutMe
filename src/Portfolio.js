...
const Portfolio = () => {
    ...
    return ( <div name = "portfolio" className="pt-10 bg-gradient-to-b from-black to-gray-500 w-full text-white md:h-full">
        <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full ">
            ...
            {ports.map(({id,source})=> {
                ...
                <div key={id} className='hover:scale-105 duration-300 shadow-md shadow-gray-600 rounded-lg'>
                    <img src={source} alt='' className=' rounded-md hover:scale-120 duration-200'/>
